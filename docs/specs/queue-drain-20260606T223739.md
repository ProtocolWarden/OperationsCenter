...
3. **Test fixtures for malformed .console/ files** — Create 5–7 synthetic fixture repositories with intentional policy violations (missing required sections, oversized log, invalid YAML keys) and corresponding golden-truth audit reports. Target: zero false positives on all fixture violations detected by the gate.
