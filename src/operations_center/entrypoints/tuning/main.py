...
from operations_center.tuning.service import TuningRegulatorService, new_tuning_context
...
def main() -> None:
    ...
    report_root = Path("tools/report/operations_center")
    ...
    context = new_tuning_context(
        ...
        window=args.window,
        source_command="operations-center tune-autonomy",
    )
