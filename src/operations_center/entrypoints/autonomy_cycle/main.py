...
def main() -> None:
    ...
    obs_context = new_observer_context(
        ...
        settings=settings,
        source_command="operations-center autonomy-cycle (observe)",
        commit_limit=10,
        hotspot_window=25,
        todo_limit=5,
    ...
    ins_context = new_generation_context(
        ...
        history_limit=5,
        source_command="operations-center autonomy-cycle (insights)",
    )
    ...
    try:
        ...
        prop_context = new_proposer_integration_context(
            ...
            dry_run=False,
            source_command="operations-center autonomy-cycle (propose)",
        )
...
def run_pipeline(
    ...
    *,
    ...
    """
    from operations_center.decision.service import _DEFAULT_ALLOWED_FAMILIES
    from operations_center.proposer import CandidateProposerIntegrationService
    from operations_center.proposer.candidate_integration import new_proposer_integration_context
    ...
    try:
        ...
        obs_context = new_observer_context(
            ...
            base_branch=configured_base_branch,
            settings=settings,
            source_command="operations-center watcher (autonomy-refresh observe)",
            commit_limit=10,
            hotspot_window=25,
            todo_limit=5,
            logs_root=Path("logs/local"),
        ...
        ins_context = new_generation_context(
            ...
            snapshot_run_id=snapshot.run_id,
            history_limit=5,
            source_command="operations-center watcher (autonomy-refresh insights)",
        )
        ...
        dec_context = new_decision_context(
            ...
            source_command="operations-center watcher (autonomy-refresh decide)",
            dry_run=False,
        ...
        prop_context = new_proposer_integration_context(
            ...
            dry_run=False,
            source_command="operations-center watcher (autonomy-refresh propose)",
        )
