...
def produce_recommendations(
    ...
    if partial:
        ...
        recs.append(
            CalibrationRecommendation(
                ...
                affected_repo_id=repo_id,
                affected_audit_type=audit_type,
                affected_artifact_ids=[aid for f in partial for aid in f.artifact_ids],
                suggested_action=(
    ...
    if missing_files:
        ...
        recs.append(
            CalibrationRecommendation(
                ...
                affected_repo_id=repo_id,
                affected_audit_type=audit_type,
                affected_artifact_ids=[aid for f in missing_files for aid in f.artifact_ids],
                suggested_action=(
    ...
    non_external_unresolved = [f for f in unresolved if f.severity != FindingSeverity.INFO]
    ...
    if invalid_json:
        ...
        recs.append(
            CalibrationRecommendation(
                ...
                affected_repo_id=repo_id,
                affected_audit_type=audit_type,
                affected_artifact_ids=[aid for f in invalid_json for aid in f.artifact_ids],
                suggested_action=(
