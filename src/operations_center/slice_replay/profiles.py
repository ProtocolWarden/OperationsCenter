...
PROFILE_CHECKS: dict[SliceReplayProfile, list[CheckSpec]] = {
    SliceReplayProfile.FIXTURE_INTEGRITY: [
        ...
        CheckSpec(
            "copied_file_exists", per_artifact=True, required=True, apply_only_when="copied_only"
        ),
        CheckSpec(
            "metadata_only_reason_present",
            per_artifact=True,
            required=True,
            apply_only_when="metadata_only",
        ),
        CheckSpec(
            "checksum_matches_if_available",
            per_artifact=True,
            required=False,
            apply_only_when="copied_only",
        ),
    ],
    ...
    SliceReplayProfile.ARTIFACT_READABILITY: [
        ...
        CheckSpec(
            "json_artifact_reads", per_artifact=True, required=True, apply_only_when="json_artifact"
        ),
        CheckSpec(
            "text_artifact_reads",
            per_artifact=True,
            required=False,
            apply_only_when="text_artifact",
        ),
        CheckSpec(
            "checksum_matches_if_available",
            per_artifact=True,
    ...
    SliceReplayProfile.FAILURE_SLICE: [
        ...
        CheckSpec(
            "copied_file_exists", per_artifact=True, required=False, apply_only_when="copied_only"
        ),
        CheckSpec(
            "metadata_only_reason_present",
            per_artifact=True,
