    ...
    def __init__(
        ...
        *,
        ...
        self.max_changes_per_day = max_changes_per_day or _env_int(
            "OPERATIONS_CENTER_TUNING_MAX_CHANGES_PER_DAY", _DEFAULT_MAX_CHANGES_PER_DAY
        )
        self.family_cooldown_hours = family_cooldown_hours or _env_int(
            "OPERATIONS_CENTER_TUNING_FAMILY_COOLDOWN_HOURS", _DEFAULT_FAMILY_COOLDOWN_HOURS
        )
